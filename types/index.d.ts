...
export type channel = "loadstart" | "loadstop" | "loaderror" | "exit" | "message";
...
export interface Window {
     ...
     * @param headers
     */
    open(url: string, target?: string, options?: string, headers?: string): InAppBrowser;
}
...
export type InAppBrowserEventListenerOrEventListenerObject = InAppBrowserEventListener | InAppBrowserEventListenerObject;
export type InAppBrowserEventListener = (evt: InAppBrowserEvent) => void;
